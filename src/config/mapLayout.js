...
export const RESOURCE_TYPES = {
  carbon: {
    ...
    sellPrice: 5,
    tier: 0,
    description: 'Basic material, found everywhere',
  },
  scrap: {
    name: 'Scrap Metal',
    color: '#b87333',
    ...
    sellPrice: 15,
    tier: 1,
    description: 'Salvageable metal from wreckage fields',
  },
  crystal: {
    name: 'Crystal Ore',
    color: '#4af',
    ...
    sellPrice: 40,
    tier: 2,
    description: 'Requires drill to mine efficiently',
    // requiresTool: 'drill', // future gating
  },
  rare_gas: {
    name: 'Nebula Gas',
    color: '#a4f',
    ...
    sellPrice: 80,
    tier: 3,
    description: 'Volatile gas found near nebulae',
  ...
  plasma: {
    ...
    sellPrice: 200,
    tier: 4,
    description: 'Extracted from the hottest zones',
    // requiresTool: 'heat_shield',
  },
};
